...
There are two ways to calculate the Log-Likelihood for the CIR model both of which are implemented in the file `functions.R` (though I am using the "Bessel" version here).
...
## Approach 3 - Revisiting approach 2 (resampling over shorter periods)
